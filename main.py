...
def load_credentials_from_file(filename=" Zozo-Cᴏᴅᴇx.txt"):
    """
    Load UID and password from  Zozo-Cᴏᴅᴇx.txt file
    """
    try:
        if not os.path.exists(filename):
        ...
        if not uid or not password:
            ...
            print("   uid=4654747415,password=F95953B095037F3BCE7B913E314EB0D4EE996E8CC723E8ECB8FA8F93E57865D4")
            print("   OR")
            print("   uid: YOUR_UID")
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][FFFF00] আরে সালা আ🤫মি  যদি Zozo-Cᴏᴅᴇx noob হয়ই  তাহলে tui একটা হিজ🤫লা
...
"""
    ...
    try:
        ...
        # Completion message
        completion_msg = f"""[B][C][FFFF00]আ🤫রে মাদার🙂চো🤫দ এখন তুই এই Title গুলা দেখ আর বল তো🤫র আব্বু আমি TAHMID-CODEX সা🤫লা  noob
"""
        await safe_send_message(chat_type, completion_msg, uid, chat_id, key, iv)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """
[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ WELCOME USER
[B][FFA500]  ┝━ [FFFFFF]HELLO, [00FF00]<USER>
[B][FFA500]  ╰━ [FFFFFF]WLC TO TAHMID-CODEX HERE
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ MESSAGE
[B][00FFFF]  কি কেমন আছো গেমে কি করো
[B][00FFFF]  লেখাপড়া করো তো পড়তে হবে
[B][FF1493]  নকল আর হবেনা
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]WLC TO [00FF00]TAHMID-CODEX BOT
"""
...
# FIXED HELP MENU SYSTEM - Now detects commands properly
                        ...
                        if inPuTMsG.strip().lower() in ("TAHMID TxT BOT", "/help", "hi", "x", "1"):
                            print(f"Help command detected from UID: {uid} in chat type: {XX}")
    

    
                            basic = """[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
...
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]STATUS: [00FF00]ACTIVE
"""
                            ...
                            emotes = """[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ V BAGE SPAM
[B][FFA500]  ┝━ [00FF00]/s1   [FFFFFF][UID]
[B][FFA500]  ┝━ [00FF00]/s2   [FFFFFF][UID]
[B][FFA500]  ┝━ [00FF00]/s3   [FFFFFF][UID]
[B][FFA500]  ╰━ [00FF00]/s4   [FFFFFF][UID]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ ULTRA POWER
[B][FFA500]  ┝━ [00FF00]/spam [FFFFFF][UID]
[B][FFA500]  ┝━ [00FF00]/spm  [FFFFFF][UID] [NUM]
[B][FFA500]  ╰━ [00FF00]/stop [FFFFFF][ALL]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]POWER: [00FF00]MAXIMUM
"""

                            await safe_send_message(response.Data.chat_type, emotes, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)            

                            evo = """[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ FUN & TOOLS
[B][FFA500]  ┝━ [00FF00]/inv   [FFFFFF][UID]
[B][FFA500]  ┝━ [00FF00]/entry [FFFFFF](UID)
[B][FFA500]  ┝━ [00FF00]/ms    [FFFFFF][MSG] [NUM]
[B][FFA500]  ╰━ [00FF00]/room  [FFFFFF][UID] [ID]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ BADGE REQUESTS
[B][FFA500]  ┝━ [00FF00]/s1 to /s5 [FFFFFF][UID]
[B][FFA500]  ╰━ [00FF00]/spam       [FFFFFF][UID] (All)
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]SYSTEM: [00FF00]ACTIVE
"""
                            await safe_send_message(response.Data.chat_type, evo, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)            
                                            

                            spam_cmnd = """[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ GAMES & JOKES
[B][FFA500]  ┝━ [00FF00]/love  [FFFFFF][Name]
[B][FFA500]  ┝━ [00FF00]/roast [FFFFFF][Name]
[B][FFA500]  ╰━ [00FF00]/luck  [FFFFFF](Luck Meter)
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ FUN TEXTS
[B][FFA500]  ┝━ [00FF00]/love  [FFFFFF][ভালোবাসা]
[B][FFA500]  ┝━ [00FF00]/dhadha[FFFFFF][ধাঁধা]
[B][FFA500]  ┝━ [00FF00]/gali  [FFFFFF][বকা দেওয়া]
[B][FFA500]  ╰━ [00FF00]/joke  [FFFFFF][Jokes]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]MODE: [00FF00]ENTERTAINMENT
"""
                            await safe_send_message(response.Data.chat_type, spam_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.6)

                            badge_cmnd = """[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ TEAM ATTACK
[B][FFA500]  ┝━ [00FF00]/ghost     [FFFFFF][Code]
[B][FFA500]  ┝━ [00FF00]/multijoin [FFFFFF][UID]
[B][FFA500]  ┝━ [00FF00]/spam_inv  [FFFFFF][UID]
[B][FFA500]  ╰━ [00FF00]/stop      [FFFFFF](Stop All)
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ PLAYER ATTACK
[B][FFA500]  ┝━ [00FF00]/lag       [FFFFFF][TmCd]
[B][FFA500]  ┝━ [00FF00]/lag_stop  [FFFFFF](Reset)
[B][FFA500]  ┝━ [00FF00]/freeze    [FFFFFF][UID/Me]
[B][FFA500]  ╰━ [00FF00]/quick     [FFFFFF][Code] [ID]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]WARNING: [00FF00]ATTACK ACTIVE
"""

                            await safe_send_message(response.Data.chat_type, badge_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            ad_cmnd = """[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ BASIC EMOTES
[B][FFA500]  ┝━ [00FF00]/bundle  [FFFFFF](List)
[B][FFA500]  ╰━ [00FF00]/bundle  [FFFFFF][Name]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ CUSTOM & FAST
[B][FFA500]  ┝━ [00FF00]@bt      [FFFFFF](Fast)
[B][FFA500]  ╰━ [00FF00]/e       [FFFFFF][Name]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ FUN & TOOLS
[B][FFA500]  ┝━ [00FF00]/luck    [FFFFFF](ভাগ্য)
[B][FFA500]  ┝━ [00FF00]/magic   [FFFFFF][TC]
[B][FFA500]  ╰━ [00FF00]/aa[nm]  [FFFFFF][TC]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]EMOTE: [00FF00]MAX READY
"""

                            await safe_send_message(response.Data.chat_type, ad_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            info_cmnd = """[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ DEVELOPER INFO
[B][FFA500]  ┝━ [FFFFFF]OWNER: [00FF00]TAHMID-CODEX BOT
[B][FFA500]  ╰━ [FFFFFF]TG:    [00FF00]@ZozoCodex
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ SYSTEM CONTROL
[B][FFA500]  ┝━ [FFFFFF]STOP:  [00FF00]/stop
[B][FFA500]  ╰━ [FFFFFF]STATUS:[00FF00] PREMIUM ACTIVE
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]POWERED BY: [00FF00]TAHMID-CODEX
"""
                            ...
                            about = """[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ EVO SYSTEM
[B][FFA500]  ┝━ [00FF00]/evo    [FFFFFF][UID] [1-21]
[B][FFA500]  ┝━ [00FF00]/evo_c  [FFFFFF][UID] [NUM]
[B][FFA500]  ┝━ [00FF00]/max    [FFFFFF][UID] [ALL]
[B][FFA500]  ╰━ [00FF00]/sm     [FFFFFF](Stop Cycle)
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ FUN & TOOLS
[B][FFA500]  ┝━ [00FF00]/luck   [FFFFFF](Check Luck)
[B][FFA500]  ┝━ [00FF00]/bundle [FFFFFF][List]
[B][FFA500]  ╰━ [00FF00]/b      [FFFFFF][Name]
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]EVO STATUS: [00FF00]MAX READY
"""
                            ...
                            whitelist_cmnd = """[B][C][FFFF00]═ ABOUT TAHMID-CODEX ═[FFFFFF]
[B]
  ❀ TAHMID খুব ভালো একটা ছেলে সে সবার সাথে মিলেমিশে থাকতে খুব ভালোবাসে।

[FFFF00]❀ এই বটটি বানাতে TAHMID সাথে তার ২ জন বন্ধু অনেক কষ্ট করে কাজ করেছে।

[00FFFF]কারো সাথে ঝগড়া নয় সবাই মিলেমিশে থাকবো

[B][C][00FF00] দয়া করে কেউ TAHMID কষ্টকে নকল করবে না
[FFFF00]━━━━━━━━━━━
"""
                            ...
                            last ="""[B][FFA500]◢◤ [FFD700]TAHMID-CODEX BOT [FFA500]◢◤
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ BOT OWNER INFO
[B][FFA500]  ┝━ [FFFFFF]OWNER: [00FF00]TAHMID-CODEX BOT
[B][FFA500]  ╰━ [FFFFFF]ID:    [00FF00]@ZozoCodex
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ❖ CONTACT FOR BUY
[B][FFA500]  │ [FFFFFF]If you want to buy bot
[B][FFA500]  │ [FFFFFF]Message me on:
[B][FFA500]  ┝━ [00FF00]TELEGRAM
[B][FFA500]  ╰━ [00FF00]TIKTOK
[B][FFA500]━━━━━━━━━━━━━━━━━━━━━
[B][FFD700]  ● [FFFFFF]TRUSTED [00FF00]OWNER Zozo-Cᴏᴅᴇx
"""
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4654747415,password=F95953B095037F3BCE7B913E314EB0D4EE996E8CC723E8ECB8FA8F93E57865D4")
        return None
